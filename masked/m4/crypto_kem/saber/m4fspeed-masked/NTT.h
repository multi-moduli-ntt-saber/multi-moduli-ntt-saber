...
static const int32_t CRT_constants[8] = {
    Q1half, Q1, Q2invRmod, Q1prime, Q2, Q2bar
};
...
extern void __asm_negacyclic_ntt_32(uint32_t *des, const int32_t *table, int32_t Qprime, int32_t Q, uint16_t *src, int32_t RmodQ);
extern void __asm_base_mul_32(uint32_t *des, const int32_t *table, int32_t Qprime, int32_t Q, uint32_t *src1, uint32_t *src2);
extern void __asm_base_mul_acc_32(uint32_t *des, const int32_t *table, int32_t Qprime, int32_t Q, uint32_t *src1, uint32_t *src2);
extern void __asm_negacyclic_intt_32(uint32_t *src, const int32_t *table, int32_t Qprime, int32_t Q);
extern void __asm_negacyclic_intt_central_32(uint32_t *src, const int32_t *table, int32_t Qprime, int32_t Q);


extern void __asm_negacyclic_ntt_16_light(uint16_t *des, const int16_t *table, int32_t QQprime, uint16_t *src);
extern void __asm_base_mul_16(uint16_t *des, const int16_t *table, int32_t QQprime, uint16_t *src1, uint16_t *src2);
extern void __asm_base_mul_acc_16(uint16_t *des, const int16_t *table, int32_t QQprime, uint16_t *src1, uint16_t *src2);
extern void __asm_negacyclic_intt_16_light(uint16_t *des, const int16_t *table, int32_t QQprime, int32_t RmodQ);

extern void __asm_CRT(uint16_t *des, uint32_t *src_32, uint16_t *src_16, const int32_t *CRT_const);

#define NTT_forward_32(out, in) __asm_negacyclic_ntt_32(out, streamlined_CT_negacyclic_table_Q1, Q1prime, Q1, in, RmodQ1)
#define NTT_forward_16(out, in) __asm_negacyclic_ntt_16_light(out, streamlined_CT_negacyclic_table_Q2, Q2Q2prime, in)

#define NTT_mul_32(des, src1, src2) __asm_base_mul_32(des, mul_Rmod_table_Q1, Q1prime, Q1, src1, src2)
#define NTT_mul_16(des, src1, src2) __asm_base_mul_16(des, mul_Rmod_table_Q2, Q2Q2prime, src1, src2)

#define NTT_mul_acc_32(des, src1, src2) __asm_base_mul_acc_32(des, mul_Rmod_table_Q1, Q1prime, Q1, src1, src2)
#define NTT_mul_acc_16(des, src1, src2) __asm_base_mul_acc_16(des, mul_Rmod_table_Q2, Q2Q2prime, src1, src2)

#define NTT_inv_32(des) __asm_negacyclic_intt_32(des, streamlined_inv_CT_negacyclic_table_Q1, Q1prime, Q1)
#define NTT_inv_central_32(des) __asm_negacyclic_intt_central_32(des, streamlined_inv_CT_negacyclic_table_Q1, Q1prime, Q1)
#define NTT_inv_16(des) __asm_negacyclic_intt_16_light(des, streamlined_inv_CT_negacyclic_table_Q2, Q2Q2prime, RmodQ2)
#define solv_CRT(des, src_32, src_16) __asm_CRT(des, src_32, src_16, CRT_constants)

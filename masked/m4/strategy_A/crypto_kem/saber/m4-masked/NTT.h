...
// gen_streamlined_inv_CT_negacyclic_table(streamlined_inv_CT_negacyclic_table_Q2, RmodQ2, expmod(invomegaQ2, 2, Q2), center_mul(expmod(RmodQ2, 2, Q2), invNQ2, Q2), invomegaQ2, Q2, &profile, 1);

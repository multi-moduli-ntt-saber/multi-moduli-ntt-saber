...
iterations = 100
testedList = [["32-bit NTT", "32-bit NTT cycles:"],
              ["32-bit base_mul", "32-bit NTT_mul cycles:"],
              ["32-bit iNTT", "32-bit NTT_inv cycles:"],
              ["16-bit NTT", "16-bit NTT cycles:"],
              ["16-bit base_mul", "16-bit NTT_mul cycles:"],
              ["16-bit iNTT", "16-bit NTT_inv cycles:"],
              ["32x16 CRT", "CRT for 32x16 cycles:"],
             ]
schemeList = ["saber"]
impleList = ["speed-masked"]
cpu = "m4f"

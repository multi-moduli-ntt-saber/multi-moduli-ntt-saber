...
extern void __asm_negacyclic_ntt_32(int32_t *des, const int32_t *root_table, uint32_t Qprime, uint32_t Q, int16_t *src);
extern void __asm_negacyclic_ntt_16(int16_t *des, const int16_t *root_table, uint32_t QQprime, int16_t *src, uint32_t RmodQ);
extern void __asm_negacyclic_ntt_16_light(int16_t *des, const int16_t *root_table, uint32_t QQprime, int16_t *src, uint32_t RmodQ);

extern void __asm_mod(int16_t *des, uint32_t QQprime, int32_t *src);
extern void __asm_mod_dual(int16_t *des1, int16_t *des2, uint32_t _Q1Q1prime, uint32_t _Q2Q2prime, int32_t *src);

extern void __asm_base_mul_32(int32_t *des, const int32_t *mul_Rmod_table, uint32_t Qprime, uint32_t Q, int32_t *src1, int32_t *src2);
extern void __asm_base_mul_16(int16_t *des, const int16_t *mul_Rmod_table, uint32_t QQprime, int16_t *src1, int16_t *src2);
extern void __asm_base_mul_32x16(int16_t *des, const int16_t *mul_Rmod_table, uint32_t QQprime, int32_t *src_32, int16_t *src_16);

extern void __asm_solv_CRT_32_m4(int32_t *des, int16_t *src1, int16_t *src2, const int32_t *_final_constants);
extern void __asm_negacyclic_intt_32(int16_t *des, const int32_t *root_table, uint32_t Qprime, uint32_t Q, int32_t *src);
